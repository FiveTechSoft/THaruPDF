...
PROCEDURE Main( cFileToSave )
   ...
   LOCAL nOffset, i // En una hoja A4 imprimo 2 copias del mismo comprobante. Esta variable ayuda con el truco
   ...
   FOR nOffset := 0 TO 14.85 STEP 14.85
      WITH OBJECT oPrint
         ...
         :CmSay( nOffset + 5.15, 5.45, 'X', oFontPrint, 0.7,,, HPDF_TALIGN_CENTER )
         ...
         IF !Empty( cBanco )
            :CmSay( nOffset + 7.15, 1.5, 'X', oFontPrint, 0.7,,, HPDF_TALIGN_CENTER )
         ELSE
         ...
         :CmSay( nOffset + 9.1, 1.2, 'X 0001-0003401', oFontPrint, 0.7,,, HPDF_TALIGN_CENTER )
